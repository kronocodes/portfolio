  ...
  return (
    <div className="bg-black flex flex-col items-center gap-y-44 text-white">
      <div className="2xl:max-w-[1300px] md:px-16 lg:max-w-[1000px] gap-y-14 w-full py-36 flex flex-col">
        ...
        <div className='px-4 text-sm text-zinc-300'>M Y &nbsp; C O D I N G &nbsp; P L A Y L I S T</div>
        </div>
          <iframe
        ...
        <div className="text-center py-10">
          <div className="md:text-3xl text-2xl font-semibold">BECAUSE THERE'S MUCH MORE</div>
          <div className="md:text-3xl text-2xl font-semibold pb-10">TO LIFE THAN PUSHING PIXELS</div>
          <Card/>
        </div>
      </div>
    </div>
