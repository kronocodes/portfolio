          ...
          <div className="md:min-w-fit md:h-[420px] h-[90vw] flex gap-x-2 md:border border-zinc-600 rounded-3xl">
            ...
            <div className="mx-auto w-full rounded-3xl bg-zinc-900 border border-zinc-700 md:hidden">
              <div className="flex flex-col items-center py-2 px-2 gap-y-2 justify-center text-zinc-300 w-full h-full">
                <a
                  className="w-full flex justify-center h-1/3 flex-col items-center rounded-2xl bg-zinc-800 border border-zinc-700"
                ...
                <a className="w-full flex justify-center h-1/3 flex-col items-center rounded-2xl bg-zinc-800 border border-zinc-700"
                ...
                <a className="px-4 rounded-2xl h-1/3 flex flex-col items-center bg-zinc-800 border border-zinc-700" 
