      ...
      {isSmallScreen ? (
          ...
          <div className="fixed z-50">
            <Link to="/" className="w-24 h-9 rounded-full text-center pt-2">
              <div className="fixed mt-7 left-8 text-3xl opacity-90 font-semibold text-white bg-black">AN.</div>
            </Link>
        ...
        <div className="fixed z-[999]">
          <Link to="/" className="w-24 h-9 rounded-full text-center pt-2">
              <div className="fixed mt-7 left-8 text-3xl opacity-80 font-semibold text-white">AN.</div>
            </Link>
