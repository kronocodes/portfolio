...
const Workh = () => {
  ...
  return (
    ...
    <div className="flex justify-between px-4 items-center">
        <div className="text-[132px]">Work</div>
        <button className="flex items-center justify-center w-48 h-28 rounded-full bg-lime-400 bg-opacity-100 backdrop-blur-[6px] hover:bg-neutral-[750] p-[5px] text-2xl ">
